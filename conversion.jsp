<%-- 
    Document   : conversion
    Created on : 1 Feb, 2020, 1:31:37 PM
    Author     : ADMIN
--%>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              ...
              <h3 class="title"><a href="">Temperature Converter</a></h3>
             <form  action="" method="post">
                <div class="form-group">
                  <input class="form-control" type="number" name="fahrenheit" placeholder="F"
                       onfocus="this.placeholder = ''" onblur="this.placeholder = 'F'"
                ></div>
                 <div class="form-group">
                <input class="form-control " type="number" name="celsius" placeholder="C"
                       onfocus="this.placeholder = ''" onblur="this.placeholder = 'C'"
                >
                </div>
                 <div class="form-group">
                     <input type="submit" class="btn primary-btn btn-lg px-5" name="ctof" value="C to F" />
                 </div>
                  <div class="form-group">
                     <input type="submit" class="btn primary-btn btn-lg px-5" name="ftoc" value="F to C" />
                 </div>
         ...
         <%
            if (result != null) {
                        try {
                            ...
                            if (ftoc != null) {
                                String far = request.getParameter("fahrenheit");
                                if (far!= null) {
                                    Double fahrenheit = Double.parseDouble(far);
